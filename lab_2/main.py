...
def bin_poick(num,chis):
    """
    Функция для бинарного поиска числа в списке с подсчетом итераций.
    Параметры:
    - num: искомое число (должно быть целым)
    - chis: список целых чисел для поиска
    Возвращает кортеж с результатом или строку ошибки.
    """
